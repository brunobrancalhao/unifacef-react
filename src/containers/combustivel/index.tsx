        ...
        <Form onSubmit={submitForm}>
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input step='any' max='99' name='gasolina' value={gasolina} onChange={handleForm} type='number' placeholder='ex R$ 4.05' />
            </Form.Field>
            <Form.Field>
              <label>Preço do Etanol</label>
              <input step='any' max='99' name='etanol' value={etanol} onChange={handleForm} type='number' placeholder='ex R$ 2.05' />
            </Form.Field>
          </Form.Group>
